...
import { itinerariesTable as itineraries } from "./schema";
...
const itinerariesData = [
  {
    ...
    faqs: [
      {
        question: "What level of physical fitness is required for this trip?",
        answer: "Moderate fitness is recommended. The climb up Sigiriya Rock involves ~1,200 steps, and Little Adam's Peak is a gentle 45-minute hike. All activities can be adjusted to your comfort level."
      },
      {
        question: "Can this itinerary be fully customized?",
        answer: "Yes, absolutely! All our itineraries serve as a starting template. We can add extra nights, adjust accommodations, or swap activities to match your preferences."
      },
      {
        question: "Is a dedicated driver and private vehicle included?",
        answer: "Yes, you will have a dedicated private air-conditioned vehicle and an experienced English-speaking driver-guide for the entire duration of your trip."
      }
    ]
  },
  {
...
seed().catch((err) => {
  console.error("❌ Seeding itineraries failed:", err);
  process.exit(1);
});
